...
🔭 Currently working on: <strong>Android Development</strong> & <strong>Machine Learning</strong>  
👯 Looking to collaborate on: <strong>Kotlin</strong>, <strong>ML</strong>, and <strong>Web Dev</strong> projects  
🌱 Learning: <strong>Advanced ML</strong> and <strong>Modern Android</strong> techniques  
💬 Ask me about: <strong>Python, Kotlin, Web Dev, DBs, Debugging</strong>  
⚡ Fun Fact: <strong>I debug more than I code – Google’s my co-pilot 😆</strong>  
...
## 🏆 GitHub Trophies
<p align="center">
  <img src="https://github-profile-trophy.vercel.app/?username=gpl-gowthamchand&theme=monokai&no-frame=true&no-bg=true&row=1&margin-w=10"/>
</p>
